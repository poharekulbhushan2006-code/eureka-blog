export const siteConfig = {
  name: 'EUREKA',
  tagline: 'Understanding the ideas behind how we think, feel, and behave.',
  description: 'Psychology, human behavior, relationships, decision-making, and the patterns that shape everyday life — explained clearly and thoughtfully.',
  ...
  footerLinks: [
    { label: 'About EUREKA', path: '/about' },
    { label: 'Privacy Policy', path: '/privacy' },
    { label: 'Terms of Service', path: '/terms' },
    { label: 'Contact & Office', path: '/contact' },
    { label: 'Author Studio', path: '/editor' }
  ],
  officeAddress: 'Nagpur & Nanded, Maharashtra, India',
  contactEmail: 'poharekulbhushan2006@gmail.com',
  engineerEmail: 'poharekulbhushan2006@gmail.com'
};
